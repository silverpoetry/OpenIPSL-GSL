...
model d_009_mdl
  ...
  // Generators
  Generation_Groups.Gen11 gen1(
    V_b=16500.0, v_0=1.04, P_0=9900000000.0, Q_0=-9900000000.0,angle_0=0) annotation(Placement(transformation(extent = {{-100, 80}, {-80, 100}})));
  Generation_Groups.Gen11 gen2(
    V_b=18000.0, v_0=1.025, P_0=163000000.0, Q_0=0,angle_0=0) annotation(Placement(transformation(extent = {{-100, 80}, {-80, 100}})));
  Generation_Groups.Gen11 gen3(
    V_b=13800.0, v_0=1.025, P_0=85000000.0, Q_0=0,angle_0=0) annotation(Placement(transformation(extent = {{-100, 80}, {-80, 100}})));
