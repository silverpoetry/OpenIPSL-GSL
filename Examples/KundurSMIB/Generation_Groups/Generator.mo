...
model Generator "Generation unit used in SMIB system"
  ...
  parameter Real xd=1.81;
  parameter Real xq=1.76;
  parameter Real x1d=0.3;
  parameter Real T1d0=8;
  /*
  OpenIPSL.Electrical.Machines.PSAT.Order6 machine(
    ...
    */
    OpenIPSL.Electrical.Machines.PSAT.Order3 machine(
    Vn=400000,
    V_b=V_b,
    ra=0.003,
    xd=xd,
    ...
    v_0=v_0,
    angle_0=angle_0,
    Sn=2220000000) annotation (Placement(transformation(extent={{20,-30},{80,30}})));
equation
