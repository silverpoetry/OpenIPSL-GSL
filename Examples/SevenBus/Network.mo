...
model Network "Seven-bus test system model, ready for simulation"
  ...
  SevenBus.Generators.G1 GEN1(M_b = 1073741823, P_0 = PF_results.machines.P21_1, Q_0 = PF_results.machines.Q21_1, V_b = 24000, angle_0 = PF_results.voltages.A21, v_0 = PF_results.voltages.V21) annotation(Placement(transformation(extent = {{-280, -142}, {-260, -122}})));
  ...
  SevenBus.Generators.G2 GEN2(M_b = 1073741823, P_0 = PF_results.machines.P61_1, Q_0 = PF_results.machines.Q61_1, V_b = 20000, angle_0 = PF_results.voltages.A61, v_0 = PF_results.voltages.V61) annotation(Placement(transformation(extent = {{280, -142}, {260, -122}})));
  SevenBus.Generators.G3 GEN3(M_b = 1073741823, P_0 = PF_results.machines.P71_1, Q_0 = PF_results.machines.Q71_1, V_b = 24000, angle_0 = PF_results.voltages.A71, v_0 = PF_results.voltages.V71) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin = {0, 158})));
  ...
  OpenIPSL.Electrical.Branches.PSSE.TwoWindingTransformer twoWindingTransformer1(ANG1 = 0.00174532925199433, B = 0, CW = 1, CZ = 2, G = 0, R = 0.0025, S_n = 1073741823, VB1 = 24000, VB2 = 380000, VNOM1 = 24000, VNOM2 = 415000, X = 0.137, t1 = PF_results.trafos.t1_2_21, t2 = PF_results.trafos.t2_2_21) annotation(Placement(transformation(origin = {-230, -132}, extent = {{6, -4}, {-6, 4}}, rotation = 180)));
  OpenIPSL.Electrical.Branches.PSSE.TwoWindingTransformer twoWindingTransformer2(ANG1 = 0.00174532925199433, B = 0, CZ = 2, G = 0, R = 0.0029, S_n = 1073741823, VB1 = 20000, VB2 = 380000, VNOM1 = 20000, VNOM2 = 405000, X = 0.1583, t1 = PF_results.trafos.t1_6_61, t2 = PF_results.trafos.t2_6_61) annotation(Placement(transformation(extent = {{-6, -4}, {6, 4}}, rotation = 180, origin = {222, -132})));
  OpenIPSL.Electrical.Branches.PSSE.TwoWindingTransformer twoWindingTransformer3(ANG1 = 0.00174532925199433, B = 0, CZ = 2, G = 0, R = 0.0025, S_n = 1073741823, VB1 = 24000, VB2 = 380000, VNOM1 = 24000, VNOM2 = 415000, X = 0.1362, t1 = PF_results.trafos.t1_7_71, t2 = PF_results.trafos.t2_7_71) annotation(Placement(transformation(extent = {{6, -4}, {-6, 4}}, rotation = 90, origin = {0, 110})));

  SevenBus.Data.PF_results PF_results
    annotation (Placement(transformation(extent={{-260,140},{-240,160}})));
  Electrical.Buses.Bus internal_bus_gen1(S_b = 1073741823, V_b = 24000, angle_0 = PF_results.voltages.A21, v_0 = PF_results.voltages.V21) annotation(Placement(transformation(origin = {-248, -132}, extent = {{-10, -10}, {10, 10}})));
  Electrical.Buses.Bus internal_bus_gen3 annotation (Placement(transformation(
        origin={0,128},
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.Buses.Bus internal_bus_gen2(S_b = 1073741823, V_b = 20000, angle_0 = PF_results.voltages.A61, v_0 = PF_results.voltages.V61) annotation(Placement(transformation(origin = {242, -132}, extent = {{-10, -10}, {10, 10}})));
equation
...
<li><code>FVERGE.v</code></li>
    ...
    experiment(StopTime = 10, StartTime = 0, Tolerance = 0.0001, Interval = 0.02));
end Network;
