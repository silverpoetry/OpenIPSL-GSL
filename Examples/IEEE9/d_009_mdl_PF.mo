...
model d_009_mdl_PF
  ...
  OpenIPSL.Electrical.Buses.Bus B1(V_b=16500, displayPF=true)
                                                annotation(Placement(transformation(extent={{-254,82},
            {-234,102}})));
  OpenIPSL.Electrical.Buses.Bus B2(V_b=18000.0) annotation(Placement(transformation(extent={{-244,82},
            {-224,102}})));
  OpenIPSL.Electrical.Buses.Bus B3(V_b=13800.0) annotation(Placement(transformation(extent={{-236,82},
            {-216,102}})));
  OpenIPSL.Electrical.Buses.Bus B4(V_b=230000.0) annotation(Placement(transformation(extent={{-230,80},
            {-210,100}})));
  OpenIPSL.Electrical.Buses.Bus B5(V_b=230000.0) annotation(Placement(transformation(extent={{-222,80},
            {-202,100}})));
  OpenIPSL.Electrical.Buses.Bus B6(V_b=230000.0) annotation(Placement(transformation(extent={{-214,80},
            {-194,100}})));
  OpenIPSL.Electrical.Buses.Bus B7(V_b=230000.0) annotation(Placement(transformation(extent={{-204,78},
            {-184,98}})));
  OpenIPSL.Electrical.Buses.Bus B8(V_b=230000.0) annotation(Placement(transformation(extent={{-192,78},
            {-172,98}})));
  OpenIPSL.Electrical.Buses.Bus B9(V_b=230000.0) annotation(Placement(transformation(extent={{-166,78},
            {-146,98}})));
  ...
  // Generators
  OpenIPSL.GENPF.GeneratorVT gen1(V_b=16500.0, v_0=1.04, P_0=9900000000.0, Q_0=-9900000000.0, angle_0=0) annotation(Placement(transformation(extent = {{-100, 80}, {-80, 100}})));
  OpenIPSL.GENPF.GeneratorPV gen2(V_b=18000.0, v_0=1.025, P_0=163000000.0, Q_0=0, angle_0=0) annotation(Placement(transformation(extent = {{-100, 80}, {-80, 100}})));
  OpenIPSL.GENPF.GeneratorPV gen3(V_b=13800.0, v_0=1.025, P_0=85000000.0, Q_0=0, angle_0=0) annotation(Placement(transformation(extent = {{-100, 80}, {-80, 100}})));
  // Loads
